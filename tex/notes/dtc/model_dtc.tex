...
\includegraphics[width=0.9\linewidth]{notes/dtc/.images/model/circuit_dtc.png}
\label{fig:DTC-circuit}
\end{subfigure}
\begin{subfigure}{0.39\textwidth}
\includegraphics[width=0.9\linewidth]{notes/dtc/.images/model/phase_diagram_labeled.png} 
...
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{notes/dtc/.images/model/ippolitti_experiment_on_sycamore_1.png}
\caption{
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{notes/dtc/.images/model/ippolitti_experiment_on_sycamore_2.png}
\caption{
