...
\input{draft/intro.tex}                                % for now just a tl;dr
\input{notes/info_lattice_defn.tex}                    % theory, fun-facts, features etc. regarding the construction of information lattice    
\input{draft/info_lattice_plots.tex}                   % plots from information lattice calculations
...
\input{notes/dtc/model_dtc.tex}                            % details of the DTC model, if needed 
