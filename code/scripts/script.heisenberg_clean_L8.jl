...
global thetalist=[collect(0.0:0.025:0.525); collect(0.6:0.05:2.0)]
global epsilon=1.0    


dest_file_name="../data/hiesenberg_transition_ordpar_clean_abanin15_L$(L).hdf5"
...
file=h5open(dest_file_name,"cw")
 ...
 attrs["[Model] 4. Range of J"]="[0.5], Uniform"

 attrs["[Model] 5. Range of h"]="[0, 2pi/3], Uniform Sampling"
